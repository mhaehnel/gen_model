...
ERIS_DIR=${ERIS_DIR:-"/eris"}
ERIS_CTRL_DIR=${ERIS_CTRL_DIR:-"/eris-ctrl"}
...
while read bench clients interval factor requests; do
    echo -n "$bench: "
...
deduplication-indexed 100 1000 500 1000
deduplication-scan 100 1000 500 10
tatp 100 1000 10 135
ssb 1 1000 1 1
EOF
)
